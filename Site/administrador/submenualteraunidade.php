...
<div id="navbar">
	...
	include "conexao.php";
	if ($_SESSION["passouparaalterar"]==null)
	{
		$frente=$_POST['id'];
		$_SESSION["id_frente"]=$frente;
	}
	
	if($_SESSION["passouparaalterar"]==1) 
	{
		
		$frente=$_SESSION["id_frentealterou"];
		//echo "<br>entrou"."Frente=".$frente;
		
		$frente=$_SESSION["id_frente"];
	}

	//echo $_SESSION["passouparaalterar"];
	//$frente=$_GET['frente'];//ID
	
	$_SESSION["idaqui"]=null;
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		...
		<div class="row">
		<center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="menualteraunidade.php" class="btn btn-primary">Voltar</a></center>
		<br><br>
