...
<body>
	...
	<div class="container contentpagina">
		<div class="row"><!--Título-->
			<center><h1 >Imagem<br>
				<small>Cadastre uma imagem para a notícia</small>
				<hr>
			</h1></center>
		...
		<div class="row">
			...
			$_SESSION['grava_nome_img_noticia'] = 's';
			$id = $_SESSION['id_noticia'];
			
			
			$sql="Select id_noticia, imagem from noticia where id_noticia = $id";
			...
			if($nome_img==''){
				...
				$sql="update noticia set imagem = '$nome_img' where id_noticia = $id";
				$resultado=pg_query($conecta,$sql);
			}
			
			$_SESSION['nome_img_noticia'] = $nome_img;
			?>

			<center>

				<img src="../img/noticias/<?php echo $nome_img; ?>.jpg" height="200px;" />
				<br><br><br>
					...
					<div class="form-group">
						...
						<form action="inseririmagem.php" method="POST" enctype="multipart/form-data">
							<div class="input-group">
								...
								<input type="hidden" name="pasta" value="../img/noticias/" >
								<input type="hidden" name="nome" value="<?php echo $nome_img; ?>" >
								<input type="hidden" name="redirect" value="editarimagem.php" >
								<input type="hidden" name="redirect_error" value="alteraimagemnoticia.php" >
								<br><br>
								...
								<div class="row">
									...
									<center>
										...
										<form action="alteraimagemnoticia.php" method="POST" enctype="multipart/form-data">
											<input type="hidden" name="nome_img" value="<?php echo $nome_img; ?>" >
											<input type="hidden" name="acao" value="apagar">
											<div class='form-group col-md-6 col-xs-6'>
											<?php
												$imagem='../img/noticias/'.$nome_img.'.jpg';
												if(file_exists($imagem))
												{?>
								...
								<div class="row">
									<center>
										<div class='form-group col-md-12 col-xs-12'>
											<a href="./listanoticias.php" class="btn btn-primary">Manter Imagem</a>
										</div>
									</center>
								</div>
							</div>
