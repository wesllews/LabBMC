...
<div id="navbar">
	...
	<body>
		...
		include "conexao.php";
		 ...
		 session_start();
		$email= $_SESSION["emailusuadm"];
		$_SESSION['email']=$email;
		$_SESSION["emailusuadm"]=null;
	...
	function data()
{
	...
	<form  action="verificacadastroadm.php" data-toggle="validator" onsubmit="tiraVerificacao()"  method="post" name="contact_form" id="contact_form">
	<div class="container-fluida">

		    <div class="col-lg-12">
				
                <center><h1>Cadastrar usuário<br>
...
<div  class='col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
	...
	<span class="input-group-addon add-on"></span>
			...
			<article class='form-group col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
				...
				<div class="input-group">
				<input id="textNome" class="form-control" placeholder="Digite o Nome" onkeypress="return letras();" name="nome" maxlength="50" type="text" required>         
				  <span class="input-group-addon add-on"></span>
				</div>
...
forceParse: 0
	...
	<div class="row">
		...
		<div class='form-group col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
		  ...
		  <center><span class="help-block">Escolha a universidade pretendida</span></center>
		</div>
		<br>
