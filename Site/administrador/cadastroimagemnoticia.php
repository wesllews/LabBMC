			...
			<center>
				...
				<aside class='form-group col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
					...
					<div class="form-group">
						...
						<form action="inseririmagem.php" method="POST" enctype="multipart/form-data" onsubmit="tiraVerificacao()">
							<div class="input-group">
								<input type="file" name="arquivo" id="fileToUpload" accept=".jpg">
								<input type="hidden" name="pasta" value="../img/noticias/" >
								<input type="hidden" name="id" value="<?php echo $_SESSION['id_noticia']; ?>" >
								...
								<div class="row">
									<center>
										...
										<div class='form-group col-md-6 col-xs-6'>
											<a href="./listanoticias.php" class="btn btn-primary" style="width: 150px;">Usar imagem padrão</a>
										</div>
									</center>
								</div>
							</div>
