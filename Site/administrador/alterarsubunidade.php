...
if($_SESSION['adm']!='s')
 header("Location: /hope/tcc/login.php");
		...
		$_SESSION["passou"]=$_SESSION["idfrentepassou"];
		$id= $_POST['id'];
...
?>
	...
	<!--Menu-->
	<form  action="gravaalteracaosubunidade.php" data-toggle="validator" onsubmit="tiraVerificacao()"  method="post" name="contact_form" id="contact_form">
...
<hr>
	...
	<br>
		...
		<a href="submenualterasub.php" class="btn btn-primary" >Voltar</a>
