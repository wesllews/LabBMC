...
<div id="navbar">
	...
	<form  action="gravaconteudo.php" data-toggle="validator" onsubmit="tiraVerificacao()" method="post" name="contact_form" id="contact_form">
...
<div  class='col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
	...
	<fieldset>
		<div class="row">
				...
				<label for="inputEmail" class="control-label"><b><h3>Id Subunidade:</b></h3></label>
				<label for="warning" class="control-label" style="color: #8a6d3b;"><h3>*</h3></label>
				<div class="input-group">
					<input id="inputEmail" class="form-control"   type="number"placeholder="Digite o ID da subunidade escolhida" maxlength="1000"  name="id_subunidade"  required> 
			...
			<aside class='form-group col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
				...
				<label for="inputEmail" class="control-label"><b><h3>Texto:</b></h3></label>
				<label for="warning" class="control-label" style="color: #8a6d3b;"><h3>*</h3></label>
				<div class="input-group">
					<input id="inputEmail" class="form-control"  placeholder="Digite o conteúdo referente a unidade escolhida. " type="text" maxlength="100"  name="texto"  required> 
					<span class="input-group-addon add-on"></span>
				</div>
