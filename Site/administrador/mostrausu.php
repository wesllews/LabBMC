...
$sql_contagem="select * from login where  adm='n' order by email ASC";
...
?>	
    ...
    <center><h1 class="page-header titulo">Usuários<br>
                  <br>
					    </h1>
					...
					<div id="produtos">
						...
						<form method="POST" action="contadm.php">
						...
						if ($qtde2 > 0)
						{
							...
							<?if ($linha["excluido"]=='s')
							{
								...
								<td><button name="emailusu"  value="<?php echo $linha[email] ?>" class="excluidinho"><?php echo $linha[email];?> </button></td>
								<td><button name="emailusu"  value="<?php echo $linha[email] ?>" class="excluidinho"><?php echo $linha2[email];?> </button></td>
								</tr>
								<?
							}
							else
							{?>
								<td><button name="emailusu" value="<?php echo $linha[email] ?>" class="linkinho"><?php echo $linha[email];?> </button></td>
								<td><button name="emailusu" value="<?php echo $linha[email] ?>" class="linkinho"><?php echo $linha2[nome];?> </button></td>
								</tr>
	   ...
	   <center>
	   		<div class="paginas">
				...
				<ul class='pagination pagination-lg pagination-sm'>
					...
					//antes      
						if($antes>0)
							echo "<li><a href='mostrausu.php?pagina=$antes' aria-label='Previous'> <span aria-hidden='true'>&laquo;
							</span> </a>  </li>";
						else
					...
					//numeros 
						for($i = 1; $i <=$tot_paginas ; $i++) {
							if ($i==$pagina)
								echo"<li class='active'><a href='mostrausu.php?pagina=$i'>$i</a></li>";
							else 
								echo "<li><a href='mostrausu.php?pagina=$i'>$i</a></li>";
						}
						
						if($depois<=$tot_paginas)
							echo "<li> <a href='mostrausu.php?pagina=$depois' aria-label='Previous'> <span aria-hidden='true'>&raquo;	</span> </a>  </li>";
						else
