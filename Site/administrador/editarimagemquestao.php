...
clearstatcache();
	...
	if($_SESSION['grava_nome_img_questao'] == 's')
	{
        $nome_img_questao = $_SESSION['nome_img_questao'];
        $id_questao = $_SESSION['id_questao'];
		$sql="update questao set imagem = '$nome_img_questao' where id_questao = $id_questao";
		$resultado=pg_query($conecta,$sql);
	}
	unset($_SESSION['grava_nome_img_questao']);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $src = '../img/questao/'.$_SESSION['nome_img_questao'].'.jpg';
    ...
    $targ_w,$targ_h
	,$_POST['w'],$_POST['h']);
 	imagejpeg($dst_r, '../img/questao/' . basename($src));
		...
		<div id="outer">
			<div class="jcExample">
				<div class="article">
					...
					        <img src="../img/questao/<?php echo $_SESSION['nome_img_questao']; ?>.jpg" id="cropbox" />
					 
					        <!-- Formulário para realização do crop-->
					        <form action="editarimagemquestao.php" method="post" onsubmit="return checkCoords(); tiraVerificacao()">
