...
?>
	...
	<!--Menu-->
	<form  action="verificatitulo.php" data-toggle="validator"  method="post" name="contact_form" id="contact_form">
...
<hr>
	...
	<span class="input-group-addon add-on"></span>
			...
			<div class='form-group col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
				...
				<textarea cols="100" id="texto" rows="5" name="texto" class="form-control" required placeholder="Digite a curiosidade" style="text-align: justify;">
				<?php
			
				if($_SESSION['texto']!='') echo $_SESSION['texto']; ?>
...
<span class="input-group-addon add-on"></span>
	...
	<!--<div class="row">
		  ...
		  <div class='form-group col-md-4 col-xs-10 col-md-offset-4 col-xs-offset-1'>
				...
				<div class="input-group">	
				<input type="date" name="data" class="form-control" id="data"  value="< ?php if($_SESSION['data']!='') echo $_SESSION['data']; ?>" onBlur="return data();" maxlength="10" required />
				<span class="input-group-addon add-on"></span>
				</div>
  <div class="help-block with-errors"></div>				
		  </div>
